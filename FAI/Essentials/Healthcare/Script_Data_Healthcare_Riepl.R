...
hospitals_official = read_sf("Data/Healthcare/Hospitals/KRANKENHAUSOGDPoint.shp")
...
doctors_ärtzekammer = read_excel("Data/Healthcare/Doctors/Doctors_Aertzekammer_adjusted.xlsx")   #7190 observations
...
output_path = here("Data/Healthcare/doctors/public_doctors.geojson")
unlink(output_path)
...
private_doctors_ärtzekammer = private_doctors_ärtzekammer |> 
 ...
 output_path = here("Data/Healthcare/doctors/private_doctors.geojson")
unlink(output_path)
...
all_doctors_ärtzekammer = read_sf("Data/Healthcare/doctors/all_doctors.geojson") |>
  mutate(type = "doctor") |>
  select(name, type, geometry)

View(all_doctors_ärtzekammer)
 
output_path = here("Data/Healthcare/doctors/all_doctors.geojson")
unlink(output_path)
...
# write to disk
output_path = here("Data/Healthcare/healthcare_points.geojson")
