...
data_ring = read_sf("Data/Aesthetics/data_ring.geojson")
data_gürtel = read_sf("Data/Aesthetics/data_gürtel.geojson")
data_borders = read_sf("Data/Aesthetics/data_borders.geojson")
data_donau = read_sf("Data/Aesthetics/data_donau.geojson")
data_donaukanal = read_sf("Data/Aesthetics/data_donaukanal.geojson")
data_lake = read_sf("Data/Aesthetics/data_lake.geojson")
